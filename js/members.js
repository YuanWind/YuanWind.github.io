(function a(argument) {
	var table = [
				...
				"湖北大学",
				 "女",
				 "软件工程1702班",
				 "学习自主性强，面对任务总是可以积极努力地完成，遇到不懂的会认真请教",
				...
				"湖北大学",
				 "男",
				 "软件工程1702班",
				 "擅长修改bug, 解决问题. 熟悉开发流程操作, 熟悉数据库和计算机网络的相关操作. 热爱编程, 热爱思考问题!",
				...
				"湖北大学",
				 "男",
				 "软件工程1702班",
				 "交际幽默，比较有耐心，做事认真，热爱编程和计算机知识，兴趣广泛，爱好听歌不喜欢唱歌，历史和哲学均有涉猎，各种编程技术都有接触，有责任心. ",
				...
				"湖北大学",
				 "女",
				 "软件工程1702班",
				 "乐观开朗，不轻易沮丧，能给身边人带来欢乐，受到启发容易产生新想法! ",
				...
				"男",
				"软件工程1702班",
				"比较有耐心，对事认真，面对问题，迎难而上，乐于学习新知识，更注重巩固旧知识"
			...
			function init() {
				...
				for ( var i = 0; i < table.length; i += 8 ) {
					...
					// object.position.x = Math.random() * 2000 - 100;
					// object.position.y = Math.random() * 2000 - 100;
					// object.position.z = Math.random() * 2000 - 100;
					object.position.x = (i-16)*100;
