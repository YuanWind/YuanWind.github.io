(function (argument) {
			var table_yy = [
				...
				"女",
				"软件工程1702班",
				"爱好：解决bug，打boss，看动画片技能：可一天24小时专注一件事情，不浮不躁"
			...
			function init() {
				...
				for ( var i = 0; i < table_yy.length; i += 8 ) {
					...
					name.className = 'name';
					name.textContent = table_yy[ i + 1];
					element.appendChild( name );

					var details = document.createElement( 'div' );
					details.className = 'details';
					details.innerHTML = table_yy[ i + 2 ] + '<br>' + table_yy[ i + 3 ];
					...
					details1.innerHTML =' 姓名:'+table_yy[ i + 1 ]+'<br>'+
										'性别:'+table_yy[i+5]+ '<br>' +
										'专业:'+table_yy[i+6]+ '<br>' +
										'教育程度:'+table_yy[ i + 3 ]+'<br>'+
										'所在地:'+table_yy[i+2]+'<br>'+
										'学校:'+table_yy[ i + 4 ];
					...
					details2.innerHTML ='个人简介:'+table_yy[ i + 7 ];
			 ...
			 // document.addEventListener( 'mousemove', onDocumentMouseMove, false );
				var oDiv=document.getElementById('container2');
			...
			function transform_yy( targets, duration ) {
